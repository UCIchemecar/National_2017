...
//Reaction variables
        ...
        if(light_level<40000 && millis()>=200 && flag_reaction==0)
        {
                ...
                t_injected=millis();
                Serial.println("There was an injection");
        }
        ...
        Serial.print(t_injected); Serial.print("            ");
        ...
        distance=(car_speed*dur_injected_to_stabilized/1000.0)-0.322 + 1.45;//Formula for calculating run distance in meters. This is only a prediction
